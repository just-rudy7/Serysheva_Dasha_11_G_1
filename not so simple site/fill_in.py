...
ginger = product(cat_id = 1, prod_name="Имбирно-пряный лимонад от Бобби", description = "Никого - кроме аллергиков - не оставит равнодушным! Очень вкусно! Очень освежает! Пряные нотки сделают вас счастливее!", price= 670, image="ginger.png")
honey = product(cat_id = 1, prod_name="Медовый лимонад от Бобби", description = "Никого - кроме аллергиков - не оставит равнодушным! Очень вкусно! Очень освежает! Медовые нотки сделают вас счастливее!", price=690, image="honeyy.png")
